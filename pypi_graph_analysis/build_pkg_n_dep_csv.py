...
pkg_table = pd.concat([dep_table[':START_ID(PKG)'],
                      dep_table[':END_ID(PKG)']], axis=0).unique()
...
dep_table[':START_ID(PKG)'] = pkg_name_table.loc[dep_table[':START_ID(PKG)']
                                                 ][':ID(PKG)'].tolist()
dep_table[':END_ID(PKG)'] = pkg_name_table.loc[dep_table[':END_ID(PKG)']
                                               ][':ID(PKG)'].tolist()
